app.controller('CreateSellerController', function ($scope, $http, $state, $mdDialog, restaurantsService, sellersService, authenticationService) {
    ...
    $scope.submit = function () {
        sellersService.create($scope.user, function () {
            $mdDialog.hide();
        });
    };
