app.controller('CreateDrinkCardController', function ($scope, $http, $state, $mdDialog, restaurantsService, drinkCardsService, authenticationService) {
    ...
    $scope.submit = function () {
        drinkCardsService.create($scope.drinkCard, function () {
            $mdDialog.hide();
        });
    };
