app.controller('CreateBartenderController', function ($scope, $http, $state, $mdDialog, restaurantsService, bartendersService, authenticationService) {
    ...
    $scope.submit = function () {
        bartendersService.create($scope.user, function () {
            $mdDialog.hide();
        });
    };
