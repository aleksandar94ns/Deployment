...
public class ManagerControllerIntegrationTest {
    ...
    private static final String BASE_URL = "/api/users/restaurantManagers";
    ...
    public void getAllManagersForbidden() throws Exception {
    ...
    @Test
    @Transactional
    public void createManagerForbidden() throws Exception {
        final Manager manager = userDao.findByEmail("res@gmail.com");
        mockMvc.perform(post(BASE_URL)
                .with(user("sys@gmail.com")
                        .authorities(new SimpleGrantedAuthority("SYSTEM_MANAGER")))
                .contentType(MediaType.APPLICATION_JSON)
                .content(TestUtils.json(manager)))
